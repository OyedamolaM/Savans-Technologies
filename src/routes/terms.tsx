        ...
        <div className="mt-10 space-y-8 text-sm leading-7 text-muted-foreground">
          <section>
            ...
            <p className="mt-3">
              ...
              lawfully and not attempt to disrupt, misuse, copy, or interfere with its operation
              or content.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              consultation, or message does not create a binding agreement until both parties
              accept a written proposal, contract, invoice, or statement of work.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              Unless otherwise agreed in writing, final custom deliverables are transferred to
              the client after full payment. Savans Technologies may retain rights to reusable
              tools, frameworks, code patterns, internal processes, and non-client-specific
              materials used to deliver the work.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              Projects may depend on hosting providers, payment gateways, analytics tools,
              domains, plugins, APIs, or other third-party services. Their availability, pricing,
              and policies are controlled by those providers.
            </p>
          </section>
